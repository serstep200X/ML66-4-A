# -*- coding: utf-8 -*-
"""
Created on Wed Feb 18 16:04:28 2026
...
load_model = pickle.load(open("C:/Users/Lab/Desktop/ML/loan_model.sav",'rb'))
with st.sidebar:
...
if(selected == 'Loan'):
    ...
    if st.button('Predict'):
     loan_prediction = load_model.predict([
                [
            float(person_age),
     ...
     if (loan_prediction[0] == 0):
          ...
          loan_prediction = 'Not Acept'
        
    else:
          
          loan_prediction = 'Acept'
